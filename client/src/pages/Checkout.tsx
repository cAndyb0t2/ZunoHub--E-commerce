...
import { canStartMockPayment, formatMockCardNumber, formatMockExpiry, mockPaymentButtonLabel } from "@shared/feedback";
...
export default function Checkout() {
  ...
  const simulatePayment = async () => {
    if (!canStartMockPayment(paymentMethod, paymentPhase)) return;
    ...
    try {
      ...
      setPaymentError(paymentFailure instanceof Error ? paymentFailure.message : "The demo payment could not be completed.");
    } finally {
